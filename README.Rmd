...
You can download the compendium as a zip from from this URL: <https://github.com/andrewjohnlowe/qvgjets/archive/master.zip>

Or you can install this compendium as an R package, qvgjets, from GitHub with:
...
[![Travis-CI Build Status](https://travis-ci.org/andrewjohnlowe/qvgjets.svg?branch=master)](https://travis-ci.org/andrewjohnlowe/qvgjets)
